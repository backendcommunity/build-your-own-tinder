...
# Mastering Backend - Dating App API: Build Your Own Tinder API

![Design preview for the Dating App API: Build Your Own Tinder API](https://pub-63da695b9ece47c5b3b49bd78b86d884.r2.dev/Dating%20App%20API%20Build%20Your%20Own%20Tinder%20API.png)
...
The project is to build **Dating App API: Build Your Own Tinder API** and get the front end working (the front end has already integrated the API).

[Click here to view more details about this project.](https://app.masteringbackend.com/projects/dating-app-api:-build-your-own-tinder-api)
...
Your task is to Build Your Own Tinder API. You will find an SQLite database file called `db.sqlite` inside the root folder. You will find the front end of each project on the project description page. 
